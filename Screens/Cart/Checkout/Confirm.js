        ...
        {finalOrder ? (
          <View>
            ...
            <View style={{ padding: 8, marginLeft: 20 }}>
              <Text>Địa chỉ giao hàng 1: {finalOrder.order.order.shippingAddress1}</Text>
              <Text>Địa chỉ 2: {finalOrder.order.order.shippingAddress2}</Text>
              <Text>Thành phố: {finalOrder.order.order.city}</Text>
              <Text>Tỉnh: {finalOrder.order.order.state}</Text>
              <Text>Mã bưu chính (ZIP): {finalOrder.order.order.zip}</Text>
